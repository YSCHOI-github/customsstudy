...
**요약하자면:** 
- 법률인 MIA는 위험의 성질이 바뀌는 변동 사항에 대해 보험자가 책임을 벗어날 수 있는 기본 원칙과 예외의 근거(제49조)를 마련해 두었습니다. 
- 실무에서는 화주가 선박의 실제 운항을 통제할 수 없다는 현실을 반영하여, ICC의 제8조, 제9조, 제10조 등을 통해 **'피보험자의 통제 범위를 벗어난 사유'**이거나 **'피보험자가 알지 못한 사유'**로 발생한 이로 및 지연에 대해서는 보험 효력을 상실하지 않고 혜택을 받을 수 있도록 조율하고 있는 것입니다.
